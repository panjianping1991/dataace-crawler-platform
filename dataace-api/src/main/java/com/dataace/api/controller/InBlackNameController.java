...
@Controller
@RequestMapping(value = "/p2pblacklist")
public class InBlackNameController {

	private final Logger logger = LoggerFactory.getLogger(InBlackNameController.class);
	...
	public Response getById(@PathVariable String id,HttpServletRequest request) {
		...
		result.setFieldDescriptionUrl("http://"+appConfig.getHost()+"/"+appConfig.getProject()+"/p2pblacklist/field-description");
		return result;
